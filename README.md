...
`apps/window/out` 放根目錄、`apps/breeze/dist` 放 `breeze/`,別忘了 `.nojekyll`(Next 的 `_next/` 開頭是底線,Jekyll 會整個忽略掉)。

影片取檔:`gh release download videos-2160 -p '*.mp4' -D apps/window/public/videos`
